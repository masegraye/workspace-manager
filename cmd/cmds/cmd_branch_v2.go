...
// NewBranchCommandV2 creates the new service-based branch command
func NewBranchCommandV2() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "branch-v2",
		Short: "Manage branches across workspace repositories (new architecture)",
...
Uses the new service architecture for improved reliability and performance.

Examples:
  # Create a new branch across all repositories
  wsm branch-v2 create feature/new-api

  # Create a new branch with tracking
  wsm branch-v2 create feature/new-api --track
  ...
  wsm branch-v2 list`,
	...
	cmd.AddCommand(
		NewBranchCreateCommandV2(),
		NewBranchSwitchCommandV2(),
		NewBranchListCommandV2(),
	)

	return cmd
}

func NewBranchCreateCommandV2() *cobra.Command {
	var track bool
...
func NewBranchSwitchCommandV2() *cobra.Command {
	cmd := &cobra.Command{
...
func NewBranchListCommandV2() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "list",
