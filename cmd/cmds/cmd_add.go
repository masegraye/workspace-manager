...
// NewAddCommand creates the service-based add command
func NewAddCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "add <workspace-name> [repo-names...]",
...
Examples:
  ...
  wsm add my-feature new-repo

  # Add multiple repositories to workspace
  wsm add my-feature repo1 repo2 repo3

  # Add repositories using --repos flag
  wsm add my-feature --repos repo1,repo2,repo3

  # Add repository with specific branch
  wsm add my-feature new-repo --branch feature/custom-branch

  # Preview changes without actually adding
  wsm add my-feature new-repo --dry-run

  # Force overwrite if branch already exists
  wsm add my-feature new-repo --force`,
